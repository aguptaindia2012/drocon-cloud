-- ============================================================================
-- 98. Client feed: include GPS-image status per line
-- ----------------------------------------------------------------------------
-- Adds `gps` (farmer_sprays.gps_image_present) to the client Entries feed so the
-- portal can show whether a GPS-tagged image was received for each spray.
-- Recreates the feed functions (return type change). Same scoping as sql/92.
-- ============================================================================
...
returns table(
  ...
  farmer_amount numeric, client_amount numeric, amount numeric, gps boolean, open_issue boolean)
