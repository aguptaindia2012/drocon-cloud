-- ============================================================================
-- 93. Client feed: add farmer phone + per-line billing rate
-- ----------------------------------------------------------------------------
-- The client portal Entries page now shows the farmer's phone (contact_no) and
-- the billing rate for each line. Adding output columns means the functions
-- must be dropped and recreated (Postgres can't change a function's return
-- type in place). Same scoping/rules as sql/92. Additive; safe to re-run.
-- ============================================================================
...
returns table(
  ...
  acres numeric, rate numeric, amount numeric, open_issue boolean)
