...
const TOOLS = [
  ...
  { key:"short_days",           section:"reviews", label:"Short-day Reasons", gate:"perm" },
  ...
  { key:"portal_expense",      section:"portal", label:"Submit Expenses", gate:"external", party:["consultant","authorized_partner"] },
  ...
  { key:"client_short_days",   section:"portal", label:"Short-day Reasons", gate:"external", party:["client"] },
...
const APP_BUILD = "228";   // bump with the service-worker VERSION on each deploy
